...
```bash
pip install git+https://github.com/guerschom1103/fastapi-doctor.git
```

### Installation depuis Source

```bash
git clone https://github.com/guerschom1103/fastapi-doctor.git
cd fastapi-doctor
pip install -e .
```
...
Signalez les bugs et demandez des fonctionnalités sur [GitHub Issues](https://github.com/guerschom1103/fastapi-doctor/issues).
